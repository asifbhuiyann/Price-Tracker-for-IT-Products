...
if __name__ == "__main__":
    ...
    trending_products = scrape_data(url)  # Change the variable name here

    if trending_products:  # Use the same variable name here
        with open('trending_products.json', 'w') as f:
            json.dump(trending_products, f, indent=4)
        print("Data saved to 'trending_products.json'")
